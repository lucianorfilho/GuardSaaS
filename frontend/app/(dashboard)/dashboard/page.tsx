...
import { Server, Archive, Bell, HardDrive, CheckCircle, XCircle, AlertTriangle } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        <StatCard
          ...
          sub={`${summary?.servers?.ONLINE ?? 0} online`}
          color="bg-blue-500/10 text-blue-400"
        />
        <StatCard
          icon={CheckCircle}
          label="Backups com Sucesso"
          value={summary?.jobs?.SUCCESS ?? 0}
          sub={`de ${summary?.jobs?.TOTAL ?? 0} total`}
          color="bg-green-500/10 text-green-400"
        />
        <StatCard
          icon={XCircle}
          label="Backups com Falha"
          value={summary?.jobs?.FAILED ?? 0}
        ...
        <StatCard
          ...
          value={formatBytes(summary?.storageUsedMB ?? 0)}
          sub="total enviado"
